<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SoruAdminListe.aspx.cs" Inherits="WebApplication3.SoruAdminListe" %>
                    ...
                    <tbody>
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <tr>
                                <td><%#Eval("ders_adi")%></td>
                                <td><asp:HyperLink ID="HyperLink1" runat="server"  NavigateUrl='<%#"sorubazlisonuc/"+Eval("kazanim_path")%>'>Vize</asp:HyperLink></td>
                                </tr>
                             </ItemTemplate>
                            </asp:Repeater>
                   </tbody>
                    ...
                    <tbody>
                        <asp:Repeater ID="Repeater2" runat="server">
                            <ItemTemplate>
                                <tr>
                                <td><%#Eval("ders_adi")%></td>
                                <td><asp:HyperLink ID="HyperLink1" runat="server"  NavigateUrl='<%#"sorubazlisonuc/"+Eval("kazanim_path")%>'>Final</asp:HyperLink></td>
                                </tr>
                             </ItemTemplate>
                            </asp:Repeater>
                   </tbody>
                    ...
                    <tbody>
                        <asp:Repeater ID="Repeater3" runat="server">
                            <ItemTemplate>
                                <tr>
                                <td><%#Eval("ders_adi")%></td>
                                <td><asp:HyperLink ID="HyperLink1" runat="server"  NavigateUrl='<%#"sorubazlisonuc/"+Eval("kazanim_path")%>'>Bütünleme</asp:HyperLink></td>
                                </tr>
                             </ItemTemplate>
                            </asp:Repeater>
                   </tbody>
