...
namespace WebApplication3
{
    public partial class TestSınavOkuma : System.Web.UI.Page
    {
        ...
        protected void btndegerlendir_Click(object sender, EventArgs e)
        {
            ...
            deneme2 = cvpgridview.Rows[5].Cells[4].Text.ToString();
            ...
            //lbldeneme.Text = keykarakter.Length.ToString();
            double puan = 0.0;
        ...
        {
            string dosyaadi = drpyil.SelectedItem.Text + "_" + drp_donem.SelectedItem.Text + "_" + drp_yariyil.SelectedItem.Text + "_" + drp_sinavtur.SelectedItem.Text + "_" + drp_bolum.SelectedItem.Text + "_" + drp_ders.SelectedItem.Text + "_" + "Sonuc.xls";
        ...
        {
            string kul_sicil_aktif = Session["giriskulsicil"].ToString();
            fileexcel.SaveAs(Server.MapPath("sinavsonuc/") + fileexcel.FileName);
            string uzanti = (Server.MapPath("sinavsonuc/") + fileexcel.FileName).ToString();
            if (File.Exists(uzanti))
            {
                string filepathi = uzanti.Substring(uzanti.LastIndexOf('\\') + 1);
                DataSet1TableAdapters.sinav_sonucu_okutmaTableAdapter dt = new DataSet1TableAdapters.sinav_sonucu_okutmaTableAdapter();
                dt.sinavokut_insert(Convert.ToInt32(drp_bolum.SelectedValue),Convert.ToInt32(kul_sicil_aktif),Convert.ToInt32(drp_ders.SelectedValue),Convert.ToInt32(drpyil.SelectedValue),drp_yariyil.SelectedItem.Text,drp_sinavtur.Text,filepathi);
