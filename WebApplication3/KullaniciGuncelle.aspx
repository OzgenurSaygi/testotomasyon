<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="KullaniciGuncelle.aspx.cs" Inherits="WebApplication3.KullaniciGuncelle" %>
       ...
       <div class="container was-validated">
        <div class="form-group">
            ...
            <div style="position:absolute; top: 112px; left: 10px; width: 679px;">
                ...
                <asp:TextBox ID="kul_adi"  runat="server" CssClass="form-control" placeholder="Ad" ></asp:TextBox>
                <div class="valid-feedback">Başarılı</div>
                <div class="invalid-feedback">Lütfen Boş Alanları Doldurunuz</div>
            </div>
            <div style="position:absolute; top: 210px; left: 10px; width: 679px;">
                ...
                <asp:TextBox ID="kul_soyadi"  runat="server" CssClass="form-control" placeholder="Soyad" ></asp:TextBox>
                <div class="valid-feedback">Başarılı</div>
                <div class="invalid-feedback">Lütfen Boş Alanları Doldurunuz</div>
            </div>
            <div style="position:absolute; top: 310px; left: 10px; width: 679px;">
                ...
                <asp:TextBox ID="kul_sifre"  runat="server" CssClass="form-control" placeholder="Soyad" ></asp:TextBox>
                <div class="valid-feedback">Başarılı</div>
                <div class="invalid-feedback">Lütfen Boş Alanları Doldurunuz</div>
            </div>
