...
{
    public partial class SinavAdminListe : System.Web.UI.Page
    {
        ...
        protected void btngetir_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand("select d.ders_adi ,s.kazanim_path from ders_bilgileri d,sinav_sonucu_okutma s  where s.donem_id=@getdonem and s.bolum_id=@getbolumid and s.yariyil=@getyariyil and s.sicil_no=@getsicil and s.ders_kodu=d.ders_kodu and s.sinav_turu='Vize' ", con);
            ...
            cmd2 = new SqlCommand("select d.ders_adi ,s.kazanim_path from ders_bilgileri d,sinav_sonucu_okutma s  where s.donem_id=@getdonem and s.bolum_id=@getbolumid and s.yariyil=@getyariyil and s.sicil_no=@getsicil and s.ders_kodu=d.ders_kodu and s.sinav_turu='Final' ", con);
            ...
            cmd3 = new SqlCommand("select d.ders_adi ,s.kazanim_path from ders_bilgileri d,sinav_sonucu_okutma s  where s.donem_id=@getdonem and s.bolum_id=@getbolumid and s.yariyil=@getyariyil and s.sicil_no=@getsicil and s.ders_kodu=d.ders_kodu and s.sinav_turu='Bütünleme' ", con);
