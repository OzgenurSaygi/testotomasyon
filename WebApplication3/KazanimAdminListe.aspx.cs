...
{
    public partial class KazanimAdminListe : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string kul_sicil_aktif = Session["girissicil"].ToString();
        ...
        protected void btngetir_Click(object sender, EventArgs e)
        {
            ...
            int kulsicil = Convert.ToInt32(txtsicil.Text);
            SqlConnection con;
            SqlCommand cmd, cmd2, cmd3;
            string constring = ConfigurationManager.ConnectionStrings["OptikOkuyucuDbConnectionString"].ConnectionString;
            con = new SqlConnection(constring);
            cmd = new SqlCommand("select d.ders_adi ,k.kazanim_path from ders_bilgileri d,kazanim_bazli_okutma k  where k.donem_id=@getdonem and k.bolum_id=@getbolumid and k.yariyil=@getyariyil and k.sicil_no=@getsicil and k.ders_kodu=d.ders_kodu and k.sinav_turu='Vize' ", con);
            ...
            cmd.Parameters.AddWithValue("@getsicil", Convert.ToInt32(kulsicil));
            con.Open();
            ...
            reader.Close();
            cmd.Dispose();
            cmd2 = new SqlCommand("select d.ders_adi ,k.kazanim_path from ders_bilgileri d,kazanim_bazli_okutma k  where k.donem_id=@getdonem and k.bolum_id=@getbolumid and k.yariyil=@getyariyil and k.sicil_no=@getsicil and k.ders_kodu=d.ders_kodu and k.sinav_turu='Final' ", con);
            ...
            cmd2.Parameters.AddWithValue("@getsicil", Convert.ToInt32(kulsicil));
            ...
            cmd3 = new SqlCommand("select d.ders_adi ,k.kazanim_path from ders_bilgileri d,kazanim_bazli_okutma k  where k.donem_id=@getdonem and k.bolum_id=@getbolumid and k.yariyil=@getyariyil and k.sicil_no=@getsicil and k.ders_kodu=d.ders_kodu and k.sinav_turu='Bütünleme' ", con);
            ...
            cmd3.Parameters.AddWithValue("@getsicil", Convert.ToInt32(kulsicil));
