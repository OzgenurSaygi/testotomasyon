...
<body style="margin-top:0px;margin-left:0px">
    <form id="form1" runat="server">
       ...
       <div style="position:absolute; top: 86px; left: 860px; width: 367px; height: 501px; margin-top: 1px; border-radius:10px 10px; background-color:#ffbf40">
          ...
          <div class="auto-style4"><asp:Label ID="lbluyari" runat="server" Text=""></asp:Label></div>
           <div class="auto-style1" >
               <asp:Button ID="btnadmingiris" runat="server" CssClass="btn btn-dark" Text="Giriş Yap" Width="144px" OnClick="btnadmingiris_Click" />
            </div>
